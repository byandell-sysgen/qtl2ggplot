...
When plotting gene annotations in region scans, multiple genes often overlap within identical base pair windows. `qtl2ggplot` delegates vertical row assignment to a fast C++ routine `arrange_genes()` ([`src/arrange_genes.cpp`](https://github.com/byandell-sysgen/qtl2ggplot/blob/main/src/arrange_genes.cpp)):
